...
tags: example
name: Date picker
description: Form-associated date selection using the platform calendar
order: 6
---

<p>The date picker wraps the platform calendar in a Workshop control, preserving native localization and keyboard behavior while adding consistent labels, validation, sizing, and form participation.</p>
...
| Method | Description |
| --- | --- |
| `showPicker()` | Opens the platform date picker when supported. |
